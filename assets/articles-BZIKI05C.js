...
- GitHub: [ColdBrando](https://github.com/ColdBrando)
- Email: your-email@example.com
`,date:"2026-01-23",tags:["AI","API","LLM","Guide","Tutorial"],readTime:15},{id:"building-with-claude",title:{en:"Building a Personal Website with Claude Code: From Zero to Live",zh:"与Claude Code共建个人网站：从零到上线"},excerpt:{en:"I've always wanted to create a personal blog to share my technical articles and insights. But every time I thought about the work involved - learning ...",zh:"我一直想建立一个个人博客网站，分享我的技术文章和心得。但每次想到需要学习React、TypeScript、配置构建工具、部署到GitHub Pages等一系列工作，就觉得太复杂，迟迟没有动手。..."},contentEn:`# Building a Personal Website with Claude Code: From Zero to Live
...
//# sourceMappingURL=articles-BZIKI05C.js.map
